...
- [?] A6 — Tag v1.0.0-hub, wait a week, resubmit         status: blocked       owner: cha-ndler  updated: 2026-05-16  pr: #355, refresh pending  note: **HOLD — do not tag or resubmit** until the 6 issues filed during the 2026-05-16 in-game validation pass are resolved: #483 (clue panel overlap), #484 (data fix AKQ→AIQ), **#485 (P0 systemic ARRIVE_AT_TILE auto-advance regression)**, #486 (C7 debug overlay incomplete — blocks Tier C validation), #487 (C5 quest count mismatch), **#488 (F1/F2 sync UX — hub privacy review blocker)**. The 2026-05-19 earliest-push target is voided. Quiet-week countdown restarts only after a clean re-run of validation log Phases 2-5. User decision 2026-05-16: "i don't want to deploy this to the plugin hub until things are fully functional."
