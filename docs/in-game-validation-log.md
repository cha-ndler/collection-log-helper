...
## PR fix/c1-actor-death-manual — C1: terminal multi-item ACTOR_DEATH steps → MANUAL *(merged #781; Catacombs live-confirmed 2026-06-09)*
...
| 3 | Catacombs of Kourend step[3]: kill any Catacombs monster — step stays live across kills; advances only as dark totem pieces drop (1/500) | `[x]` | **Live-confirmed 2026-06-09** (harness 0.2, logged in): drove to step 4/4, then `itemObtained 19679` -> `Target slot unlocked ... completing guidance` -> `Guidance sequence complete`. MANUAL terminal completes via `onItemObtained`, not a dead-end. See acceptance-runs/2026-06-09.md. |
